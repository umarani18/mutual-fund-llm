                ...
                <div className="relative z-10 animate-in fade-in slide-in-from-top-4 duration-700">
                    ...
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-150">
                        <h2 className="text-5xl lg:text-6xl font-black leading-tight tracking-tight">
                            Smart <br />
                            <span className="text-primary-foreground/80 italic">Learning Simulator.</span>
                        </h2>
            ...
            <div className="flex-1 bg-background flex items-center justify-center p-6 lg:p-10 relative h-full overflow-hidden">
                <div className="w-full max-w-md animate-in fade-in slide-in-from-right-4 duration-700">
                    <div className="mb-8 lg:text-left text-center">
                        ...
                        <p className="text-muted-foreground text-sm font-medium pt-2">Login to access your AI Learning Assistant.</p>
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="block w-full pl-11 pr-11 py-3.5 bg-muted/50 border border-border rounded-2xl text-foreground focus:outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary/50 transition-all font-medium placeholder-muted-foreground/50 hover:border-primary/30 hover:bg-muted/70"
                                    placeholder="••••••••"
                                />
                                <button
                                    type="button"
                        ...
                        >
                            {loading ? (
                                ...
                                <>
                                    <span className="uppercase tracking-widest text-[11px]">Sign In to Portal</span>
                    ...
                    <p className="mt-8 text-center text-muted-foreground text-[12px] font-bold">
                        New to MF Research? <Link href="/signup" className="text-primary hover:underline font-black hover:text-primary/80 transition-colors">Register an account</Link>
                    </p>
